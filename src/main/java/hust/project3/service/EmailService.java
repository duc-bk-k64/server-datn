...
public class EmailService {
	...
	public String sendMailRegister(String code, String email) throws Exception {
		try {
			...
			msg.setText("Thân gửi bạn!\n"
					+ "Hệ thống đã nhận được yêu cầu đăng kí tài khoản của bạn. Đây là mã code để kích hoạt tài khoản. Vui lòng không tiết lộ mã code với bất kỳ ai, nếu tiết lộ, bạn có nguy cơ bị mất tài khoản.   Truy cập đường link http://localhost:4200/#/auth/active để kích hoạt tài khoản. \n"
					+ "Code : " + code + "\n" + "Nếu không phải bạn, vui lòng bỏ qua email này.\n \n \n"
					+ "Trân trọng cảm ơn!\n" + "Vũ Văn Đức.\n" + "SĐT: 0336280763");
			mailSender.send(msg);
			return "send mail successfully";
